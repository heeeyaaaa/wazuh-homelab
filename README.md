...
> 📖 Full setup guide: [heeeyaaaa.github.io/posts/wazuh-homelab](https://heeeyaaaa.github.io/posts/wazuh-homelab/)
...
| `local_decoder.xml`              | Decoder for screencast-watch log events          |
...
| `screencast-watch.sh`            | Watches PipeWire for screen/window capture, logs events |
| `screencast-watch.service`       | Systemd user service running screencast-watch.sh |
